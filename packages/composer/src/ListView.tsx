...
export default function ListView({ items, ariaLabel = "Items", empty, className }: ListViewProps) {
  if (items.length === 0) return <div className={className} data-vc-component="list-view" data-vc-empty>{empty}</div>;
  return (
    <ul aria-label={ariaLabel} className={className} data-vc-component="list-view">
