...
3. A canonical record in the current `packages/registry/components*.json` phase file including props, states, accessibility checks, replacement targets, showcase fixtures, and Doctor rules.
